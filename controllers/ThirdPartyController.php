...
use app\models\ThirdPartySearch;
...
/**
 * ThirdPartyController implements the CRUD actions for ThirdParty model.
 */
class ThirdPartyController extends Controller
{
    ...
    public function actionGetThirdParty()
    {
        Yii::$app->response->format = Response::FORMAT_JSON;
        $thirdParty = ThirdParty::find()->all();
        return $thirdParty;
    ...
    {
        if (($model = ThirdParty::findOne($id)) !== null) {
            return $model;
        } else {
